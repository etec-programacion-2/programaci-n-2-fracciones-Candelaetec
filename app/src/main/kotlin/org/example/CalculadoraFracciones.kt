...
fun convertirADecimal(scanner: Scanner) {
    val fraccion = leerFraccion(scanner, "Ingrese una fracción:")
    println("Valor decimal de $fraccion = ${fraccion.aDecimal()}")
}
...
fun main() {
    ...
    var opcion = -1  // ✅ Inicializada correctamente
    ...
    do {
        ...
        try {
            ...
            println("Error: Debe ingresar un número entre 0 y 8.")
            scanner.nextLine()
            continue
        }
